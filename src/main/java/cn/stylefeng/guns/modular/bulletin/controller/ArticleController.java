...
public class ArticleController extends BaseController {
     ...
     */
    @RequestMapping("/edit")
    @BussinessLog(value = "编辑参数", key = "articleId", dict = ArticleMap.class)
    @ResponseBody
...
//        oldBulletin.setMainImg(article.getMainImg());
     ...
     */
    @RequestMapping("/add")
//    @BussinessLog(value = "添加简介文章", key = "name", dict = ArticleMap.class)
    @ResponseBody
    ...
    @BussinessLog(value = "删除简介文章", key = "articleId", dict = ArticleMap.class)
    @ResponseBody
